...
exports.addDiary = exports.getEntriesWithOutInfo = exports.findById = exports.getEntries = void 0;
...
const addDiary = (newDiaryEntry) => {
    const newDairy = Object.assign({ id: Math.max(...diaries.map(d => d.id)) + 1 }, newDiaryEntry);
